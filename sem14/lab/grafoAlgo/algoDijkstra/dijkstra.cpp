/*
 * nombreProg : dijkstra.cpp
 * descripcion: Algorti Dijsktra
 *
 *      Ingrese los datos de un grafo y compruebe al algoritmo
 *		  Plantee un problema de la realidad y solucione el problema
 *		  interpretando los resultados del algoritmo..
 * autor:
 * fecha:
 */
...
int opera()
{
   ...
   //Completamos solo los pares de nodos conectados
   A[0][1] = 16;
   A[0][2] = 10;
   A[0][3] = 5;
   ...
   // calcular dijkstra a partir del nodo 0, al nofo 7
...
void dijkstra( int N, int **A, int a, int b )
{
   ...
   // continuamos este ciclo mientras existan nodos no visitados
   while ( 1 ) {
      /* busca entre todos los nodos no visidos el de menor peso, descartando los
       * de peso infinito (-1)
       */
      peso = -1;
      i0 = -1;
