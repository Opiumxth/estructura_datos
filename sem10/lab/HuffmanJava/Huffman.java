 /**
 * @(#)Huffman.java
 *	La clase Huffman define los atributos y metodos necesarios
 *  para creacion del arbol de Huffman
 *
 *
...
public class Huffman {
	...
	//holds the frequency of the item
	private static int table[] = new int[0x7f]; 
	//the main Priority Queue, the Final Tree generated is stored in spot 0.
	private static Node myNode[]; 
	//The true length of the table that holds the characters.	
	private static int lengthOfTable = 0;
	//A variable that holds the Tree
