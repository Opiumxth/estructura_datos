...
// Extraer el nodo con el valor mínimo (menor frecuencia)
...
// Verificar si el nodo es una hoja (carácter real)
...
struct MinHeapNode* buildHuffmanTree(char data[], int freq[], int size)
{
    ...
    while (minHeap->size != 1) {
        ...
        // Crear un nodo interno '$' con frecuencia igual a la suma de ambos
...
// Imprimir los códigos recorriendo el árbol (0 izquierda, 1 derecha)
...
// Automatizar el cálculo de frecuencias desde una cadena de texto
...
int main()
{
    char text[] = "algoritmos y estructura de datos";
