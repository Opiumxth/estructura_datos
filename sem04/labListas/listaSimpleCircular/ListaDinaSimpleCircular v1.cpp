...
void insertarAntes(NODO **cab, int dato, int adato);
...
int main()
{
   ...
   //borrarLista(&A);
   //insertarAntes(&a, 30, 35);
   insertarAntes(&a, 15, 5);
   mostrarLista(a);
