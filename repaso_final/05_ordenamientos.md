...
1. ¿Por qué el ordenamiento de datos es fundamental para optimizar búsquedas y otras operaciones?
2. ¿Cuál es la diferencia entre ordenamientos estables e inestables y cuándo importa esta distinción?
3. ¿Qué problema resuelve el ordenamiento por inserción cuando los datos están casi ordenados?
4. ¿Cómo se relaciona la complejidad temporal de un algoritmo de ordenamiento con el tamaño de los datos?
5. ¿Qué ocurriría si aplicas burbuja a un arreglo ya ordenado?
6. ¿Cuándo conviene usar QuickSort y cuándo MergeSort?
7. ¿Cómo se relacionan los algoritmos de ordenamiento con la memoria disponible?
8. ¿Qué ventajas y desventajas tiene cada algoritmo de ordenamiento en diferentes escenarios?
