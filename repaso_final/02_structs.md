...
### ¿Qué es un struct?
Un struct agrupa **variables de distintos tipos** bajo un solo nombre. Es la forma de modelar entidades del mundo real en C/C++.
...
> Este struct ES la pieza de LEGO con la que construyes listas, pilas y colas.
...
1. ¿Por qué los structs son fundamentales para agrupar datos relacionados en estructuras complejas?
2. ¿Cuál es la diferencia entre acceder a un campo de un struct con `.` y con `->`?
3. ¿Cómo se relaciona el tamaño de un struct con el alineamiento de memoria en C/C++?
4. ¿Qué ventajas ofrece usar un arreglo de structs en lugar de arreglos separados para cada campo?
5. ¿Qué ocurriría si intentas acceder a un campo de un struct que no ha sido inicializado?
6. ¿Cuándo conviene pasar un struct por valor y cuándo por referencia?
7. ¿Cómo se relacionan los structs con los punteros en la implementación de estructuras de datos?
8. ¿Qué problema resuelve el uso de structs en comparación con variables independientes?
...
**Ejercicio 2.4 (Tipo examen):** Escriba la función `crearNodo` usando `new` en vez de `malloc`. ¿Qué cambia en la liberación?
