...
**Pseudocódigo:**
```
ACCION intercambiar(ENTERO *pa, ENTERO *pb)
   ENTERO temp
   temp ← *pa
   *pa ← *pb
   *pb ← temp
...
**Ejercicio 1.3 (Ambos):** Escriba primero en pseudocódigo y luego en C/C++ una función `void invertir(int* arr, int n)` que invierta un arreglo usando dos punteros.
