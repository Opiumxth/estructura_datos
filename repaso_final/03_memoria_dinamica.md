...
1. ¿Por qué la memoria dinámica es necesaria cuando no conocemos el tamaño de los datos en tiempo de compilación?
2. ¿Cuál es la diferencia entre `new` y `malloc` y cuándo se usa cada uno?
3. ¿Qué problema resuelve el uso de memoria dinámica en comparación con arreglos estáticos?
4. ¿Cómo se relaciona el concepto de memory leak con la gestión de memoria dinámica?
5. ¿Qué ocurriría si olvidas liberar memoria en un programa que se ejecuta por mucho tiempo?
6. ¿Cuándo conviene usar `delete` y cuándo `delete[]`?
7. ¿Cómo se relaciona la memoria dinámica con la implementación de estructuras de datos como listas y árboles?
8. ¿Qué ventajas y desventajas tiene la memoria dinámica respecto a la memoria estática?
