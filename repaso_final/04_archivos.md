...
1. ¿Por qué los archivos son necesarios para la persistencia de datos más allá de la ejecución del programa?
2. ¿Cuál es la diferencia entre archivos de texto y archivos binarios y cuándo se usa cada uno?
3. ¿Qué problema resuelve el uso de archivos en comparación con almacenar datos solo en memoria?
4. ¿Cómo se relaciona el modo de apertura de un archivo con las operaciones permitidas?
5. ¿Qué ocurriría si olvidas cerrar un archivo después de usarlo?
6. ¿Cuándo conviene usar fwrite y cuándo fprintf?
7. ¿Cómo se relacionan los archivos con structs para guardar estructuras de datos complejas?
8. ¿Qué ventajas y desventajas tiene el almacenamiento en archivos respecto a bases de datos?
