...
1. ¿Por qué los punteros son necesarios para implementar estructuras de datos dinámicas como listas enlazadas?
2. ¿Cuál es la diferencia entre `*p` y `&x` y en qué situaciones se usa cada uno?
3. ¿Qué problema resuelve el uso de punteros dobles (`**`) al pasar la cabeza de una lista a una función?
4. ¿Cómo explicarías a un compañero la diferencia entre un puntero sin inicializar y un puntero nulo?
5. ¿Qué relación existe entre la aritmética de punteros y el acceso a arreglos?
6. ¿Cuándo conviene usar aritmética de punteros en lugar de índices con corchetes?
7. ¿Qué ocurriría si olvidas liberar memoria reservada dinámicamente en un programa que se ejecuta por mucho tiempo?
8. ¿Cómo se relacionan los punteros con el concepto de paso por referencia en funciones?
