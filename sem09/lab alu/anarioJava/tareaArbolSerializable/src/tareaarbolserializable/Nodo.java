...
public class Nodo<T> {
    ...
    public void setDato(T vdato) { this.dato = vdato; }
    public void setPadre(Nodo<T> vpadre) { this.padre = vpadre; }
    ...
    public Nodo<T> getPadre() { return this.padre; }
    public List<Nodo<T>> getHijos() { return this.hijos; }
    public Nodo<T> getHijoEn(int posicion) { return hijos.get(posicion); }
